...
依恋研究：它认得我 & 那是它爱我，这道题问的是我爱谁 & 因变量全长在动物身上；它越真实我方越成立\\
...
\item “肥胖数据是美国的吧？” → 是，这是我方的局限，中国没有可比的体况调查。但服装、写真的比例就在国内问卷里。
...
\section{如果……就……}
\begin{contingency}
\ifthen{对方定义不同，或拿出没预料到的数据}{当场指出定义杀，问“把狗喂到走不动路算不算爱它”；对数据先问机构、年份、样本，再问因变量在谁身上。}
\ifthen{论点一被打穿，或对方指控我方犬儒、回避必问}{收缩到论点二，用肥胖与认知落差扛全场，那组数据发生在进门之后；被指控犬儒就撇清“我方承认你爱它”，回避就点名不换题。}
\end{contingency}
\section{全场三条铁律（背下来）}
\begin{enumerate}[leftmargin=1.8em,itemsep=2pt,topsep=2pt]
