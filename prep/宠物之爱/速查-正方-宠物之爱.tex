...
拟人化：你爱的是投射 & 投射不会被纠正，这份感情天天在被它纠正 & 我按它的反应改，不按我的想象坚持\\
短头品种是按审美选的 & 那是买之前的审美，爱是进门之后的事 & 买的人和爱的人在时间上是两个阶段\\
喂胖了、穿衣服伤了它 & 无知推不出自私，做错事不等于没爱 & 父母逼你多穿一件，效果也常常是错的\\
弃养 & 用不爱它的人来定义爱，方法本身有问题 & 请给家庭弃养的占比，给不出就只是印象\\
自我延伸：我变大了 & 自我延伸本来解释爱情，照这用法都是自恋 & 它真的会拒绝：会咬你、会躲、会跳走\\
\bottomrule\end{longtable}
\section{必问与必答}
\begin{fields}
\field{必问 （对方不答就点名）}{
...
\section{如果……就……}
\begin{contingency}
\ifthen{对方定义不同，或拿出没预料到的数据}{先用“命题不可证伪”这一击（那会让母爱、爱情全都“更是我”），再把中立判准两条通道复述一遍；对方只肯要“冲突时刻”一条通道就答：冲突时刻是必要检验，不是唯一检验。对数据先问机构、年份、样本，再问它测的因变量在谁身上。}
\ifthen{论点二被打穿（对方拿 Badhwar 打不可替代），或对方回避必问}{收缩到论点一，用“冲突时让路的是我”扛全场；回避就点名、重复、不换题，第二次不答就说“这个问题对方已经两次没有回答”。}
\end{contingency}
\section{全场三条铁律（背下来）}
\begin{enumerate}[leftmargin=1.8em,itemsep=2pt,topsep=2pt]
